...
description: "Find and install an additional skill when no installed skill adequately covers the requested task; do not activate for work already handled by an available skill."
---
